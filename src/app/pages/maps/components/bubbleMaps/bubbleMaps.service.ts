...
export class BubbleMapsService {
  ...
  getData(mapArray) {
    ...
    /*let mapData = [
      ...
      {'code': 'AU', 'name': 'Australia', 'value': 226057, 'color': layoutColors.warningDark},
    ...
    return {
      ...
      theme: 'blur',
      titles: [
        {text: 'Number of transactions per country', size: 14},
        {text: 'source: CAPE Transactional data', size: 11}
      ],
