...
export class ChartistJsService {
  ...
  private _data = {
    ...
    creditLineData: {
      labels: ['24 Nov', '25 Nov', '26 Nov', '30 Nov'],
      series: [
        [1500, 1600, 2000, 2300, 3000],
        [1500, 2100, 3000, 3300, 4000],
        [1000, 1200, 1500, 2000, 3300],
        [550, 1100, 2000, 4000, 5000],
        [3000, 3500, 4200, 5000, 6200]
      ]
    },
    debitLineOptions: {
      color: this._baConfig.get().colors.defaultText,
